...
<br>
View the live site [here](https://robertdavid1205.github.io/SssssneakySnake-ms2)(Open it in a new tab)
<br><br>
...
### User Stories
---
1. As an employer I can check for validation of various coding skills in this project, from html and css, UX and UI, to javascript and API and check for interactiveness.
...
3. As a developer I can get ideas for my own project and I can send my feedback to the owner, I will also get confirmation that my message was sent.
